...
<div class="main-content">
    ...
    <div class="search-container">
        ...
        <div class="datetime">
        <?php
            date_default_timezone_set('Asia/Makassar');  // Setting timezone to Jakarta. Change this as per your need.
            echo date('l, d F Y, H:i:s T');  // e.g. Monday, 24 October 2023, 14:30:45 WIB
        ?>
    </div>
    </div>
